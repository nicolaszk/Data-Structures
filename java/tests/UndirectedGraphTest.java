    ...
    public static void main(String[] args){
        ...
        while(true){
            ...
            switch(choice){
                ...
                break;
                case 4:
                    System.out.println("Choose what integer to remove from the graph:  ");
                    int removableInteger = in.nextInt();
                    s = (graph.removeVertex(removableInteger)) ? "Vertex removed successfully!": "Apparently vertex isnt in the graph";
                    System.out.println(s);
                break;
